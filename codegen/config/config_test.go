...
func TestAutobinding(t *testing.T) {
	cfg := Config{
		...
		AutoBind: []string{
			...
			"github.com/DoNotPayHQ/gqlgen-fork/example/scalars/model",
		},
	}
	...
	require.Equal(t, "github.com/DoNotPayHQ/gqlgen-fork/example/scalars/model.Banned", cfg.Models["Banned"].Model[0])
	require.Equal(t, "github.com/DoNotPayHQ/gqlgen-fork/example/chat.Message", cfg.Models["Message"].Model[0])
}
