...
# see https://github.com/DoNotPayHQ/gqlgen-fork/issues/694
type Content_User {
  foo: String
}
...
`},
	&ast.Source{Name: "weird_type_cases.graphql", Input: `# regression test for https://github.com/DoNotPayHQ/gqlgen-fork/issues/583
...
type XxIt { id: ID! }
`},
	&ast.Source{Name: "wrapped_type.graphql", Input: `# regression test for https://github.com/DoNotPayHQ/gqlgen-fork/issues/721
...
func (ec *executionContext) field_Query_directiveInputType_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["arg"]; ok {
		...
		if data, ok := tmp.(InnerInput); ok {
			...
			return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/DoNotPayHQ/gqlgen-fork/codegen/testserver.InnerInput`, tmp)
		}
	}
	args["arg"] = arg0
	return args, nil
...
func (ec *executionContext) _Query_noShape(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp := ec._fieldMiddleware(ctx, nil, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be github.com/DoNotPayHQ/gqlgen-fork/codegen/testserver.Shape`, tmp)
	})
	...
	for k, v := range asMap {
		...
		case "thirdParty":
			...
			if data, ok := tmp.(*ThirdParty); ok {
				...
				return it, fmt.Errorf(`unexpected type %T from directive, should be *github.com/DoNotPayHQ/gqlgen-fork/codegen/testserver.ThirdParty`, tmp)
			}
		}
	}
