...
```bash
$ go run github.com/DoNotPayHQ/gqlgen-fork init
```
...
```bash
$ go run github.com/DoNotPayHQ/gqlgen-fork -v
```
...
```bash
$ rm resolver.go
$ go run github.com/DoNotPayHQ/gqlgen-fork
```
...
```go
//go:generate go run github.com/DoNotPayHQ/gqlgen-fork
```
